  ...
  return (
    ...
    <section className="container-projects">
       ...
       <div class="card-inner">
        ...
        <img  src={pageweb} alt="sebas"/><button>Description</button>
        </div>
    ...
    <div class="card-inner">
    <div className='card-front'>
        <img  src={traveling} alt="sebas" /><button>Description</button>
        </div>
        <div className='card-back'>
          <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Repudiandae facere quo reprehenderit. Ipsam libero dolorum voluptate totam asperiores magnam cum veniam. Quaerat autem nobis eligendi ipsum id rerum ex dolorum.</p>
    ...
    <div class="card-inner">
    <div className='card-front'>
        <img  src={atlas} alt="sebas" /><button>Description</button>
        </div>
        <div className='card-back'>
          <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Repudiandae facere quo reprehenderit. Ipsam libero dolorum voluptate totam asperiores magnam cum veniam. Quaerat autem nobis eligendi ipsum id rerum ex dolorum.</p>
    ...
    <div class="card-inner">
    <div className='card-front'>
        <img  src={finance} alt="sebas" /><button>Description</button>
        </div>
        <div className='card-back'>
          <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Repudiandae facere quo reprehenderit. Ipsam libero dolorum voluptate totam asperiores magnam cum veniam. Quaerat autem nobis eligendi ipsum id rerum ex dolorum.</p>
    ...
    <div class="card-inner">
    <div className='card-front'>
        <img  src={store} alt="sebas" /><button>Description</button>
        </div>
        <div className='card-back'>
          <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Repudiandae facere quo reprehenderit. Ipsam libero dolorum voluptate totam asperiores magnam cum veniam. Quaerat autem nobis eligendi ipsum id rerum ex dolorum.</p>
    ...
    <div class="card-inner">
    <div className='card-front'>
        <img  src={form} alt="sebas" /><button>Description</button>
        </div>
        <div className='card-back'>
          <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Repudiandae facere quo reprehenderit. Ipsam libero dolorum voluptate totam asperiores magnam cum veniam. Quaerat autem nobis eligendi ipsum id rerum ex dolorum.</p>
